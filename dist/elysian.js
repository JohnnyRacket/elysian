...
var Elysian = {
    ...
    InputMapper: InputMapper_1.InputMapper.getInstance(),
    GameObjects: {
...
var Bootstrap = /** @class */ (function () {
    ...
    Bootstrap.create = function (canvasId, width, height) {
        ...
        var inputMapper = InputMapper_1.InputMapper.getInstance();
...
var ImageViewObject = /** @class */ (function (_super) {
    ...
    function ImageViewObject(x, y, width, height, angle, drawingStrategy, callback, imgSource) {
        var _this = _super.call(this, x, y, width, height, angle, drawingStrategy, callback) || this;
        _this.imgSource = "";
        _this.onUpdate = function () { };
        if (!drawingStrategy)
    ...
    ImageViewObject.prototype.render = function () {
        if (this.imgSource) {
            this.context.clearRect(0, 0, this.width, this.height);
            var img_1 = new Image();
            img_1.src = this.imgSource;
            this.context.webkitImageSmoothingEnabled = false;
            this.context.mozImageSmoothingEnabled = false;
            this.context.imageSmoothingEnabled = false;
            img_1.onload = function () {
                this.context.drawImage(img_1, 0, 0, this.width, this.height);
            }.bind(this);
        }
    };
